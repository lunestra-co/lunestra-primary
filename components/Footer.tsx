      ...
      <div className="max-w-[1800px] mx-auto px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-24 border-b border-white/10 pb-12">
          ...
          <div className="space-y-6">
            <h4 className="text-[11px] font-bold uppercase tracking-widest mb-6">Explore</h4>
            <ul className="space-y-3 text-sm font-light text-gray-400">
              <li><Link href="/" className="hover:text-white transition-colors">Home</Link></li>
              <li><Link href="/jewellery" className="hover:text-white transition-colors">Collections</Link></li>
              <li><Link href="/gems" className="hover:text-white transition-colors">Gem Products</Link></li>
              <li><Link href="/jewellery" className="hover:text-white transition-colors">Jewellery Products</Link></li>
              <li><Link href="/journal" className="hover:text-white transition-colors">Journal</Link></li>
            </ul>
          </div>
          {/* 2️⃣ Customer Care */}
          <div className="space-y-6">
            <h4 className="text-[11px] font-bold uppercase tracking-widest mb-6">Customer Care</h4>
            <ul className="space-y-3 text-sm font-light text-gray-400">
              ...
              <li><Link href="/account" className="hover:text-white transition-colors">Orders</Link></li>
              <li><Link href="/policies" className="hover:text-white transition-colors">Policies</Link></li>
            </ul>
          </div>
          {/* 3️⃣ Our Company */}
          <div className="space-y-6">
            <h4 className="text-[11px] font-bold uppercase tracking-widest mb-6">Our Company</h4>
            <ul className="space-y-3 text-sm font-light text-gray-400">
          ...
          {/* Newsletter */}
          <div className="space-y-6">
            <h4 className="text-[11px] font-bold uppercase tracking-widest mb-6">Latest from {settings.siteName}</h4>
            <div className="flex flex-col gap-4">
              <input type="email" placeholder="Enter your email" className="bg-transparent border-b border-white/30 py-2 text-white placeholder-gray-500 focus:outline-none focus:border-white transition-colors" />
              <button className="text-left text-[10px] uppercase tracking-widest font-bold hover:text-gray-300">Subscribe</button>
            </div>
          </div>
        </div>
