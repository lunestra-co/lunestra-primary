...
export default function GemProducts() {
        ...
        <table className="w-full text-left text-xs">
          <thead className="bg-gray-50 text-xs uppercase text-gray-500 font-medium border-b sticky top-0">
            <tr>
              ...
              <th className="px-6 py-4 whitespace-nowrap">Clarity</th>
              ...
              .map((product) => (
                <tr key={product.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 text-right">
                    <Link
                      href={`/admin/gem-products/${product.id}`}
